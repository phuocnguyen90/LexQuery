...
from utils.provider_utils import get_groq_provider, get_default_provider
...
def query_rag(query_text: str, provider=None) -> QueryResponse:
    """
    ...
    # Step 4: Define the system prompt with clear citation instructions
    system_prompt = '''
    ...
    '''
    logger.debug(f"System prompt defined for query: {query_text}")
    ...
    try:
        ...
        response_text = provider.send_message(prompt=full_prompt)
